#pragma checksum "/root/c#dev/WebDev/Pages/Icons/flags.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "99164ee44c9debec226994b8931bc7a84050266a"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(CoreUI_Free_Bootstrap_Admin.Pages.Icons.Pages_Icons_flags), @"mvc.1.0.razor-page", @"/Pages/Icons/flags.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"99164ee44c9debec226994b8931bc7a84050266a", @"/Pages/Icons/flags.cshtml")]
    ...
    public class Pages_Icons_flags : global::Microsoft.AspNetCore.Mvc.RazorPages.Page
    {
        ...
        {
#nullable restore
#line 2 "/root/c#dev/WebDev/Pages/Icons/flags.cshtml"
...
<div class=""container-fluid"">
    <div class=""animated fadeIn"">
        <div class=""card"">
            ...
            <div class=""card-body"">
                <div class=""row"">
                    ...
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                        <i class=""f");
            WriteLiteral(@"lag-icon flag-icon-ae h1"" id=""ae"" title=""ae""></i>
          ...
          ");
            WriteLiteral(@"          </div>
                    ...
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                      ");
            WriteLiteral(@"  <i class=""flag-icon flag-icon-as h1"" id=""as"" title=""as""></i>
            ...
            WriteLiteral(@"v>
                    ...
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
         ");
            WriteLiteral(@"               <i class=""flag-icon flag-icon-be h1"" id=""be"" title=""be""></i>
            ...
            WriteLiteral(@"5"">
                   ...
                   ");
            WriteLiteral(@"     <div>flag-icon-bt</div>
                    </div>
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
      ...
      ");
            WriteLiteral(@"                  <div>flag-icon-cg</div>
                    </div>
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
            ...
            WriteLiteral(@"2 col-xs-3 text-center mb-5"">
                    ...
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                        <i class=""flag-icon flag-icon-cu h1"" id=""cu"" title=""cu");
            WriteLiteral(@"""></i>
            ...
            WriteLiteral(@"lass=""col-sm-2 col-xs-3 text-center mb-5"">
                    ...
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                        <i class=""flag-icon flag-icon-dm h1"" id=""");
            WriteLiteral(@"dm"" title=""dm""></i>
            ...
            WriteLiteral(@"n-et h1"" id=""et"" title=""et""></i>
...
");
            WriteLiteral(@"                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                    ...
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                        <i class=""flag-");
            WriteLiteral(@"icon flag-icon-gd h1"" id=""gd"" title=""gd""></i>
            ...
            WriteLiteral(@"      </div>
                    ...
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                        <i");
            WriteLiteral(@" class=""flag-icon flag-icon-gp h1"" id=""gp"" title=""gp""></i>
 ...
 ");
            WriteLiteral(@"                   </div>
                    ...
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
             ");
            WriteLiteral(@"           <i class=""flag-icon flag-icon-hm h1"" id=""hm"" title=""hm""></i>
            ...
            WriteLiteral(@"on-hu</div>
                    ...
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
");
            WriteLiteral(@"                        <i class=""flag-icon flag-icon-in h1"" id=""in"" title=""in""></i>
                    ...
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                       ...
                       ");
            WriteLiteral(@" <div>flag-icon-is</div>
                    </div>
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
          ...
          ");
            WriteLiteral(@"              <div>flag-icon-ki</div>
                    </div>
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
            ...
            WriteLiteral(@"l-xs-3 text-center mb-5"">
                    ...
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                        <i class=""flag-icon flag-icon-lb h1"" id=""lb"" title=""lb""></");
            WriteLiteral(@"i>
            ...
            WriteLiteral(@"=""col-sm-2 col-xs-3 text-center mb-5"">
                    ...
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                        <i class=""flag-icon flag-icon-ly h1"" id=""ly"" ");
            WriteLiteral(@"title=""ly""></i>
            ...
            WriteLiteral(@"   <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                    ...
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                        <i class=""flag-icon flag-icon-ml");
            WriteLiteral(@" h1"" id=""ml"" title=""ml""></i>
    ...
    ");
            WriteLiteral(@"                <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                    ...
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                        <i class=""flag-icon");
            WriteLiteral(@" flag-icon-mu h1"" id=""mu"" title=""mu""></i>
            ...
            WriteLiteral(@"  </div>
                    ...
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                        <i cla");
            WriteLiteral(@"ss=""flag-icon flag-icon-nf h1"" id=""nf"" title=""nf""></i>
     ...
     ");
            WriteLiteral(@"               </div>
                    ...
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                 ");
            WriteLiteral(@"       <i class=""flag-icon flag-icon-om h1"" id=""om"" title=""om""></i>
            ...
            WriteLiteral(@"g</div>
                    ...
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
    ");
            WriteLiteral(@"                    <i class=""flag-icon flag-icon-pn h1"" id=""pn"" title=""pn""></i>
                    ...
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                        ...
                        <di");
            WriteLiteral(@"v>flag-icon-pw</div>
                    </div>
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                    ...
                    <div class=""col-sm-2 col-xs-3 text-cente");
            WriteLiteral(@"r mb-5"">
              ...
              ");
            WriteLiteral(@"          <div>flag-icon-sb</div>
                    </div>
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
 ...
 ");
            WriteLiteral(@"                       <div>flag-icon-sl</div>
                    </div>
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
            ...
            WriteLiteral(@"l-sm-2 col-xs-3 text-center mb-5"">
                    ...
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                        <i class=""flag-icon flag-icon-sy h1"" id=""sy"" titl");
            WriteLiteral(@"e=""sy""></i>
            ...
            WriteLiteral(@"div class=""col-sm-2 col-xs-3 text-center mb-5"">
                    ...
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                        <i class=""flag-icon flag-icon-tl h1""");
            WriteLiteral(@" id=""tl"" title=""tl""></i>
        ...
        ");
            ...
            WriteLiteral(@"g-icon-ua h1"" id=""ua"" title=""ua""></i>
            ...
            WriteLiteral(@"div>
                    ...
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                        <i class=""");
            WriteLiteral(@"flag-icon flag-icon-vg h1"" id=""vg"" title=""vg""></i>
         ...
         ");
            WriteLiteral(@"           </div>
                    ...
                    <div class=""col-sm-2 col-xs-3 text-center mb-5"">
                     ");
            WriteLiteral(@"   <i class=""flag-icon flag-icon-zm h1"" id=""zm"" title=""zm""></i>
